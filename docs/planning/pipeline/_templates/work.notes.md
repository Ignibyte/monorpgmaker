...
- Ticket:
- AAR id (from `aar-open`):
- EARS requirements reviewed:
...
- Findings:
  ...
  |---|---|---|---|---|
- (If clean: "no findings; lenses covered: …")

## Phase 4 — Validate
- Tests added:
- `dotnet test MonoRpgMaker.slnx`: <result>
- `bin/gate.sh`: <GREEN / steps>
