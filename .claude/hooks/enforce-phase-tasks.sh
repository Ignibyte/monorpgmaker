...
# A fully archived pipeline (doc moved to completed/) has no open phase to
# enforce. Without this guard, a context-summarized transcript can leave
# detect_active_command pinned to an old phase marker indefinitely.
